...
def abs(x: float) -> float:
    ...
    returns the absolute value of `x` as a number.
...
# -------------------------------------------------------------------------------
def dict(value: Any = None) -> dict[Any, Any]:
    """
    Creates a dictionary.

    overloads:
    `dict()` creates an empty dictionary.
    `dict(value)` creates a dictionary from `value` if possible (e.g., mapping or sequence of key-value pairs).
...
# -------------------------------------------------------------------------------
def len(value: Iterable[Any] | dict[Any, Any] | str | list[Any]) -> int:
    """
    Returns the length of a collection or string.

    returns the number of elements/items in `value`.
...
# -------------------------------------------------------------------------------
def list(iterable: Optional[Iterable[Any]] = None) -> list[Any]:
    """
    Creates a list.

    overloads:
    `list()` creates an empty list.
    `list(iterable)` creates a list containing the elements from `iterable`.
...
def max(*values: Any) -> Any:
    ...
    `max(iterable)` returns the largest element of `iterable`.
...
def min(*values: Any) -> Any:
    ...
    `min(iterable)` returns the smallest element of `iterable`.
...
# -------------------------------------------------------------------------------
def range(start: int, stop: Optional[int] = None, step: int = 1) -> Iterable[int]:
    """
    Creates an iterable of integers.
    ...
    returns an iterable producing integers in the specified range.
...
# -------------------------------------------------------------------------------
def set(value: Optional[Iterable[Any]] = None) -> set[Any]:
    """
    Creates a set.

    overloads:
    `set()` creates an empty set.
    `set(iterable)` creates a set with unique elements from `iterable`.
